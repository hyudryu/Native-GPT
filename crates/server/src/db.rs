...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "0005_remote_hosts",
        include_str!("../migrations/0005_remote_hosts.sql"),
    ),
    (
        "0006_generated_assets",
        include_str!("../migrations/0006_generated_assets.sql"),
    ),
    ("0007_voices", include_str!("../migrations/0007_voices.sql")),
];
